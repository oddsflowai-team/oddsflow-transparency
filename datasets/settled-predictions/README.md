...
<!--SNAPSHOT:START-->
**Settled-predictions dataset (snapshot: 2026-08-10):**

| Metric | Value |
|--------|-------|
| Settled bets | 985 |
| Won / Lost | 318 / 268 |
| Half-won / Half-lost | 131 / 140 |
| Push / Void | 128 / 0 |
| Total staked | 144,535.89 units |
| **Net profit/loss** | **+19,818 units** |
| **ROI** | **+13.7%** |
| Matches / Competitions | 731 / 42 |
