...
<!--SNAPSHOT:START-->
**Settled-predictions dataset (latest settled match: 2026-09-14):**

| Metric | Value |
|--------|-------|
| Settled bets | 40,439 |
| Won / Lost | 18486 / 15643 |
| Half-won / Half-lost | 1632 / 856 |
| Push / Void | 0 / 3822 |
| Total staked | 7,348,017.37 units |
| **Net profit/loss** | **+809,204 units** |
| **ROI** | **+11%** |
| Matches / Competitions | 4799 / 126 |
