...
<!--SNAPSHOT:START-->
**Settled-predictions dataset (latest settled match: 2026-09-03):**

| Metric | Value |
|--------|-------|
| Settled bets | 25,236 |
| Won / Lost | 12378 / 10046 |
| Half-won / Half-lost | 412 / 175 |
| Push / Void | 0 / 2225 |
| Total staked | 6,562,563.17 units |
| **Net profit/loss** | **+762,915 units** |
| **ROI** | **+11.6%** |
| Matches / Competitions | 3497 / 120 |
