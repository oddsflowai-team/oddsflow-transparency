...
<!--SNAPSHOT:START-->
**Settled-predictions dataset (latest settled match: 2026-09-08):**

| Metric | Value |
|--------|-------|
| Settled bets | 32,471 |
| Won / Lost | 15519 / 12479 |
| Half-won / Half-lost | 1007 / 508 |
| Push / Void | 0 / 2958 |
| Total staked | 6,922,567.37 units |
| **Net profit/loss** | **+808,796 units** |
| **ROI** | **+11.7%** |
| Matches / Competitions | 4062 / 125 |
