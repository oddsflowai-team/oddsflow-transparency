...
<!--SNAPSHOT:START-->
**Settled-predictions dataset (snapshot: 2026-08-17):**

| Metric | Value |
|--------|-------|
| Settled bets | 1,607 |
| Won / Lost | 560 / 417 |
| Half-won / Half-lost | 210 / 190 |
| Push / Void | 230 / 0 |
| Total staked | 183,897.69 units |
| **Net profit/loss** | **+24,827 units** |
| **ROI** | **+13.5%** |
| Matches / Competitions | 1117 / 85 |
