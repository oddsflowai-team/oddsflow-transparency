...
<!--SNAPSHOT:START-->
**Settled-predictions dataset (snapshot: 2026-07-20):**

| Metric | Value |
|--------|-------|
| Settled bets | 782 |
| Won / Lost | 253 / 212 |
| Half-won / Half-lost | 109 / 114 |
| Push / Void | 94 / 0 |
| Total staked | 130,960.89 units |
| **Net profit/loss** | **+18,846 units** |
| **ROI** | **+14.4%** |
| Matches / Competitions | 587 / 20 |
