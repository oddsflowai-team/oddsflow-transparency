...
<!--SNAPSHOT:START-->
**Settled-predictions dataset (latest settled match: 2026-09-05):**

| Metric | Value |
|--------|-------|
| Settled bets | 27,668 |
| Won / Lost | 13427 / 10901 |
| Half-won / Half-lost | 591 / 288 |
| Push / Void | 0 / 2461 |
| Total staked | 6,684,722.17 units |
| **Net profit/loss** | **+774,978 units** |
| **ROI** | **+11.6%** |
| Matches / Competitions | 3709 / 125 |
